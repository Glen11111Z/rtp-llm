...
TEST_F(SamplerTest, testCandidateGreedyFastPath) {
    size_t batch_size = 3;
    size_t vocab_size = 6;

    auto logits = torch::tensor({0.0f, 2.0f, 0.0f, 3.0f, 0.0f, 10.0f,
                                 0.0f, 4.0f, 0.0f, 1.0f, 0.0f, 9.0f,
                                 0.0f, 1.0f, 0.0f, 5.0f, 0.0f, 8.0f},
                                torch::kFloat32)
